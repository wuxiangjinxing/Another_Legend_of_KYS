...
function createSceneData()
	...
	-- 城村客栈
	scene[1] = {
		{JY.Scene[70]["名称"], JY.Scene[70]["进入条件"], 70}, -- 小村
		...
		{JY.Scene[107]["名称"], JY.Scene[107]["进入条件"], 107}, -- 襄阳
		{JY.Scene[69]["名称"], JY.Scene[69]["进入条件"], 69}, -- 天上人间
		{JY.Scene[110]["名称"], JY.Scene[110]["进入条件"], 110}, -- 苏州
		{JY.Scene[111]["名称"], JY.Scene[111]["进入条件"], 111}, -- 衡阳
		{JY.Scene[112]["名称"], JY.Scene[112]["进入条件"], 112}, -- 荆州
	...
	scene[2] = {
		...
		{JY.Scene[106]["名称"], JY.Scene[106]["进入条件"], 106}, -- 绿柳山庄
		{JY.Scene[108]["名称"], JY.Scene[108]["进入条件"], 108} --玉笔山庄
	}
	-- 名门大派
	scene[3] = {
	...
	scene[5] = {
		...
		{JY.Scene[46]["名称"], JY.Scene[46]["进入条件"], 46}, -- 金蛇洞
		{JY.Scene[10]["名称"], JY.Scene[10]["进入条件"], 10}, -- 蜘蛛洞
		{JY.Scene[7]["名称"], JY.Scene[7]["进入条件"], 7}, -- 神雕洞
    ...
    scene[7] = {
        ...
        {JY.Scene[80]["名称"], JY.Scene[80]["进入条件"], 80}, -- 华山后山
...
function showMoveMenu()
	...
	local menu = {"城村客栈", "庄园居所", "名门大派", "奇教帮会", "山洞幽谷", "海外岛屿", "迷宫秘境", "其他场所"};
	local numItem = 8
	local sceneList = createSceneData();

	lib.GetKey()
	
    maxlength = string.len("城村客栈")
